...
var questionnaire_monProgrammeSchema = new mongoose.Schema({
    "titre": {
        "type": "String"
    },
    "directive": {
  ...
  var mongooseQuestionnaire_monProgramme = mongoose.model("questionnaire_monProgramme", questionnaire_monProgrammeSchema);
